...
def load_config():
    ...
    if os.getenv('DISCORD_TOKEN'):
        config = {
            ...
            'guild_id': int(os.getenv('GUILD_ID', '1401938108160934029')),
            'whitelist_channel_id': int(os.getenv('WHITELIST_CHANNEL_ID', '1401938109402189838')),
            'whitelist_team_channel_id': int(os.getenv('WHITELIST_TEAM_CHANNEL_ID', '1402376743377043536')),
            'whitelist_role_id': int(os.getenv('WHITELIST_ROLE_ID', '1401938108202614935')),
            'questions': [
        ...
        try:
            ...
            config = {
                ...
                'guild_id': 1401938108160934029,
                'whitelist_channel_id': 1401938109402189838,
                'whitelist_team_channel_id': 1402376743377043536,
                'whitelist_role_id': 1401938108202614935,
                'questions': [
                    "Qual é o seu nome completo?",
                    "Qual é a sua idade?",
                    "Você já jogou roleplay antes? Se sim, conte sua experiência.",
